  ...
  return (
    <div className="bg-chocolate font-jura text-white">
      <Main className="relative h-full min-h-screen">
        <Nav className="fixed w-full top-0 bg-blackberry-500 h-64 px-10" />

        <div className="flex bg-blackberry h-screen text-white py-64">{children}</div>
      ...
      <NavMobile className="fixed w-full bottom-0 bg-blackberry-500 z-50 shadow-md border-t border-plum" />
    </div>
  );
}
