...
function Construction(props) {
  return (
    <section
      ...
      <div className="absolute z-10 top-225">
      ...
      <div className="flex flex-col gap-30 items-center absolute top-0 bg-blackberry m-25 px-35 pt-22 pb-22 rounded-md">
        ...
        <a
          className="text-gum border border-gum rounded-md p-10 hover:bg-plum hover:text-white"
          href="https://myoshis.ch"
          target="_blank">
